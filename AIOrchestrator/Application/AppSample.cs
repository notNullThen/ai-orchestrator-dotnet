...
";
    ...
    [
        new()
        {
            ...
            Parameters =
            [
                new() { Name = "location", Description = "The location for which to retrieve the weather forecast.", },
            ],
        },
        new() { Name = nameof(GetLocation), Description = "Retrieves the current location.", Parameters = [], },
        new() { Name = nameof(Exit), Description = "Terminates the program.", Parameters = [], },
    ];
}
